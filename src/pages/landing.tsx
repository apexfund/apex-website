...
function HeroLabel({ children }: { children: React.ReactNode }) {
  return (
    <div style={{ marginBottom: 20 }}>
      <span style={{ color: 'rgba(12,25,41,0.55)', fontSize: 11, fontWeight: 600, letterSpacing: '0.14em', textTransform: 'uppercase' as const }}>
        {children}
      </span>
    </div>
  )
...
function StripLabel({ children }: { children: React.ReactNode }) {
  return (
    <div style={{ marginBottom: 20 }}>
      <span style={{ color: 'rgba(12,25,41,0.5)', fontSize: 11, fontWeight: 600, letterSpacing: '0.14em', textTransform: 'uppercase' as const }}>
        {children}
      </span>
    </div>
  )
